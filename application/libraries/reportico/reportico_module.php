 ...
 * @version $Id: run.php,v 1.68 2014/05/17 15:12:31 peter Exp $
 */
...
class Reportico_module extends reportico_object
{
    ...
    */
	...
	function initialize_panels($mode)
	{
        ...
        $partialajaxpath = base_url( "partial" );
...
class reportico_module_criteria extends Reportico_module
{
	function __construct()
	{
	}
