...
<div id="container">
    ...
    <div class="right-invoice">
        ...
        <section id="invoice-title-number">
            ...
            <div class="title-top">
                ...
                $todaydate = $dt->format('Y-m-d');
                 echo $todaydate;?></span>
                <span><?php echo $todaydate;?></span> <span id="number"> OBID<?php echo $booking->booking_id; ?></span>
            </div>
        ...
        <section id="client-info">
            ...
            <div>
                <span><?php echo $booking->nic_number; ?></span>
            </div>
        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <?php }
                $promocoderate =$booking->promocode_rate;
                $promocodeMax =$booking->promocode_max;
                $promoDiscount = min ( $promocodeMax, ($totalprice*(1 - $promotions->promo_amount)*$days* $promocoderate));
                if ($promocoderate > 0) { ?>
                    <tr>
                        <th>Promocode Discount</th>
                        <td contenteditable='false'>(LKR. <?php echo number_format((float)($promoDiscount), 2, '.', '');?>)</td>
                    </tr>
                <?php }
                ...
                <tr class="amount-total">
                    <!-- {amount_total_label} -->
                    <td colspan="2">LKR. <?php echo number_format((float)($booking->total_from_customer), 2, '.', '');?></td>
                </tr>
                ...
                <tr data-hide-on-quote="true" class="due-amount">
                    <th>Amount Due</th>
                    <td style="border-bottom: double; border-top: 1px solid;">LKR. <?php echo number_format((float)($booking->total_from_customer - $booking->paid_amount), 2, '.', '');?></td>
                </tr>
    ...
    function equaltotal(){
       ...
       if (totalamount1 != totalamount2) {
        ...
        <section id="terms">
            ...
            <div>Dear <?php echo $booking->customer_name; ?>, thank you very much. We really appreciate your business.<br>Your booking is now confirmed and no need to contact us.<br><br>Please think about the environment before printing this document.</div>
