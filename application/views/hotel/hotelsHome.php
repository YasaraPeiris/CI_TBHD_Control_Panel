    ...
    <div class="content-wrapper" style="background-color:ghostwhite;">
        ...
        <section class="content" style="padding-right:5%;padding-left:5%;">
                ...
                <div class="col-md-12">
                    <div id="about_web" class="box box-solid"
                        ...
                        <div class="box-body" style="padding:0 4%;">
                            <br>
                            <table id="example_checkin" class="table table-striped nowrap table-responsive"
             ...
             float: right;text-align: right;"> - Rs.' . $row['rate'] . '</span></br>';
                                            ...
                                            <td style="max-width: 30px">
                                                <button type="button" onclick="setConfirm(this.id)"
                                                        id="<?php echo $data2[$i][0]['booking_id'] . 'c'; ?>"
                                            ...
                                            <td>
                                                <button type="button" onclick="setIgnored(this.id)"
                                                        id="<?php echo $data2[$i][0]['booking_id'] . 'i'; ?>"
          ...
          ">
                        ...
                        <div class="box-body" style="padding:0 4%;">
                            <br>
                            <table id="example_checkin_today" class="table table-striped nowrap table-responsive"
                                   cellspacing="0" width="100%">
                                <thead class="no-border">
                                <tr style="text-align:center;color:#404040;font-size: 13px;font-weight: 200;">
             ...
             float: right;text-align: right;"> - ' . $row['quantity'] . '</span></br>';
                                                } ?></td>
                ...
                <div class="col-md-12">
                    <div id="about_web" class="box box-solid"
                        ...
                        <div class="box-body" style="padding-right: 3%;padding-left: 3%;">
                            <br>
                            <p style="color:dimgrey;font-size: 15px;">A Hotel Reservation System which offer both local
                                and foreign tourists to book hotels in Sri Lanka using a smart, searchable website and
                                it lets customer to choose the best hotel to book by swiftly navigating through rates,
                                features and offers of multiple hotels in the preferred destination. Customers will be
                                provided with the facility to pay online using eZ cash or m-cash.Additional services
                                offered by this website are</p>
                            <ul style="color:dimgrey;font-size: 15px;">
                                <li>Enjoy low cost bookings</li>
                                <li>Cancellation without any cost.</li>
                                <li>Automated email and sms notification system.</li>
                                <li>Location based google api services.</li>
                            </ul>
                            <br>
                            <p style="font-size: 1.4em;font-weight: bold;text-align: center;text-decoration: underline;">
                                <a href="http://inna.lk/" style="color: #00a7d0;">inna.lk</a></p>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
