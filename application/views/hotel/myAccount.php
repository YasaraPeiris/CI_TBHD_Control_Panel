...
<!--      <div class="col-lg-4 col-xs-12">
        ...
        <div class="col-lg-6 col-xs-12" >
          ...
          <div class="small-box"  style="height:250px;text-align: center;background-color: #000044;">
            <div class="inner" style="height:200px;background: white;border:#555555;border-style: solid;border-width: 0.6em;">
            ...
            <a href="./updateHotelDetails.php" class="small-box-footer" style="height: 50px;line-height: 50px;font-size: 1.2em;;">Click Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
           <div class="col-lg-6 col-xs-12">
          <!-- small box -->
          <div class="small-box "  style="height:250px;text-align: center;background-color: #000044;">
            ...
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
                 ...
                 <a href="./updateRoomPrices.php" class="small-box-footer" style="height: 50px;line-height: 50px;font-size: 1.2em;;">Click Here <i class="fa fa-arrow-circle-right"></i></a>
      </div>
        </div>
        <!-- ./col -->
      </div>
