    ...
    <div class="content-wrapper" style="background-color:ghostwhite;">
      ...
      <section class="content-header" style="padding-right:5%;padding-left:5%;padding-top:2%;">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Last Room Details</li>
        </ol>
      </section>
      <!-- Main content -->
        ...
        <div class="row" >
          <div class="col-md-12">
            ...
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title" style="text-align: center;color:dimgrey;padding-top:6px;font-weight: bold;">Last Room Details</h3>
            </div>
            <!-- /.box-header -->
              ...
              <div style="background: white;" >
                <div class="box box-info" style="border: none;">
                  <div class="box-body pad" style="color: black;">
                    ...
                    <div class="row">
        <div class="form_box">
              <form action="<?php echo site_url(); ?>/EditDetailsController/lastRoomDelete" method="post" enctype="multipart/form-data" id="roomForm">
                <p class="para1 "> Room Type: <?php  echo $rooms->room_type; ?> Room</p>
                  <!-- <label for="rent_area">Your Rent Area</label> -->
                  <input type="hidden" name="confirmPage" value="true">
                  <p class="para1 "> Room Name: <?php  echo $rooms->room_name; ?></p>
                  <p class="para1 ">Occupancy: <?php  echo $rooms->no_of_people; ?></p>
                  <hr class="hr_style">
                  <label for="how_much">Prices Stated,</label><span></span><br>
                  <?php  
                  for ($pcat=0; $pcat < sizeof($roomCatg); $pcat++) {
                  // print_r($roomCatg[$pcat]);
                  echo $roomCatg[$pcat]->price_name." , for ".$roomCatg[$pcat]->price_occ." pax";
                  echo "<br><br>";
                  }
                  ?>
                  <br>
                  <?php 
                  $image_patharry = explode('/', $roomPic->image_path);
                  array_shift($image_patharry);
                  $image_path = implode("/",$image_patharry);
                  // echo $image_path;
                  ?>
                  <!-- <img width="50%" src="../../assets/images/colombo.jpg"> -->
                  <img width="50%" src="../../<?php  echo $image_path; ?>">
                  <input type="submit" style="background-color: #F83650" value="Delete This Room" name="finishButton">
              </form>
        </div>
